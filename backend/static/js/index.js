...
const make_company_stats_for_japan=function(object){
...
<div class="gallery-cell">
  ...
  wrapAround: true,
      ...
      var firebaseConfig = {
        apiKey: "AIzaSyCy-mgacvE6YYBBugHi9s0jUXphRLuUSgs",
        authDomain: "practice-6e4a9.firebaseapp.com",
        databaseURL: "https://practice-6e4a9-default-rtdb.firebaseio.com",
        projectId: "practice-6e4a9",
        storageBucket: "practice-6e4a9.appspot.com",
        messagingSenderId: "304971380925",
        appId: "1:304971380925:web:9cde9e2d5206919283dfd4"
      };
      // Initialize Firebase
...
const Serch_japan=()=>{
  ...
  axios.all([
    //axios.postをリストで渡す
    axios.post(`/japan_stock`,{"ticker": ticker}),
  
    ]).then(axios.spread((response) => { 
      console.log(response.data)
      make_company_stats_for_japan(response.data)
       //企業概要をカラにする
       $("#company_detail").empty();
       const h=` <tr>
         <th>企業名</th>
